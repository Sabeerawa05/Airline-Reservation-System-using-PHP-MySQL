...
<title>admin display schedulled</title>
<style type="text/css">
<!--
body {
    ...
    <tr>
      ...
      <td valign="top"><p align="center" class="style1">&nbsp;</p>
        ...
        <table border="1" align="center">
          ...
          <?php do { ?>
            <tr>
              <td><a href="admindisplayscheduledtl.php?recordID=<?php echo $row_displayschedule['schedulID']; ?>"> <?php echo $row_displayschedule['schedulID']; ?>&nbsp; </a> </td>
              <td><?php echo $row_displayschedule['From']; ?>&nbsp; </td>
              <td><?php echo $row_displayschedule['To']; ?>&nbsp; </td>
              <td><?php echo $row_displayschedule['Date']; ?>&nbsp; </td>
              <td><?php echo $row_displayschedule['Time']; ?>&nbsp; </td>
              <td><?php echo $row_displayschedule['Price']; ?>&nbsp; </td>
            </tr>
            <?php } while ($row_displayschedule = mysql_fetch_assoc($displayschedule)); ?>
        </table>
        <br>
        <?php echo $totalRows_displayschedule ?> Records Total
        </p></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
